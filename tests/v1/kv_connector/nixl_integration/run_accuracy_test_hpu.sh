...
run_tests_for_model() {
  ...
  PROXY_CMD="python ./tests/v1/kv_connector/nixl_integration/toy_proxy_server.py --port 9195"
...
#       }'
  ...
  #TEST_MODEL=$model_name python -m pytest -s -x ./tests/v1/kv_connector/nixl_integration/test_accuracy.py
  curl http://localhost:9195/v1/completions -H "Content-Type: application/json" -d '{"model": "Qwen/Qwen3-0.6B", "prompt": "What is AI? ", "max_tokens": 20}'
